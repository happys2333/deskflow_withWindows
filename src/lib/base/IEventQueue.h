...
public:
  ...
  */
  ...
  Implementations should invoke a stable copy of the handler so a handler may unregister itself while running.
  The event target object must still remain alive until the handler starts.
  */
